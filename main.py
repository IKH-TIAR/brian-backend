...
from routes import conversations, commands, bungalows, push, media, pricing, bookings, template_config, template_sends, template_send_webhook
...
app.include_router(template_send_webhook.router, prefix="/api", dependencies=[Depends(verify_admin_password)])
